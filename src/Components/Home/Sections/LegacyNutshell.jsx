        ...
        <div className="row">
          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div className="legacy-details">
              On May 8, 1974, Anand Diagnostic Laboratory began its journey in Shivajinagar, Bangalore, under Dr. A V Ramaprasad's visionary leadership. Rooted in principles of honesty and integrity, the lab became a beacon for quality diagnostics, always putting patients first. Currently, Anand Diagnostics Laboratory is known as Neuberg Anand Reference Laboratory, carrying forward its legacy of excellence and patient-centered care.e
            </div>
            <div className="nutshell">
              <div className="common-heading">
                <h2><span>About Anand Lab </span> In a nutshell </h2>
              </div>
              <div className="nutshell-count">
                <ul>
                  <li>
                    <h4 className="home-counter-text"> <span className="counter">50</span> <span className="clr-pnk">+</span> </h4>
